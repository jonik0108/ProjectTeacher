...
import com.zadira.projectteacher.databinding.FragmentThreeBinding
import com.zadira.test3.Adapter.RvAdapter
import com.zadira.test3.Model.User
import com.zadira.projectteacher.SharedPref.MyShafePreferens3
...
class Three : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding= FragmentThreeBinding.inflate(LayoutInflater.from(context))
        context?.let { MyShafePreferens3.init(it) }
        binding.add.setOnClickListener {
            ...
            dialogView.btn_close.setOnClickListener {
                ...
                MyShafePreferens3.objectsString = list
