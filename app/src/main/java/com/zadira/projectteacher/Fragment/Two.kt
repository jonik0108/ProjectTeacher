package com.zadira.projectteacher.Fragment
...
import com.zadira.projectteacher.SharedPref.MyShafePreferens2
import com.zadira.projectteacher.databinding.FragmentTwoBinding
...
class Two : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding=FragmentTwoBinding.inflate(LayoutInflater.from(context))
        context?.let { MyShafePreferens2.init(it) }
        binding.add.setOnClickListener {
            ...
            dialogView.btn_close.setOnClickListener {
                ...
                MyShafePreferens2.objectsString = list
