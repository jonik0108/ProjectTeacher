...
import com.zadira.projectteacher.databinding.FragmentFiveBinding
import com.zadira.test3.Adapter.RvAdapter
import com.zadira.test3.Model.User
import com.zadira.projectteacher.SharedPref.MyShafePreferens5
...
class Five : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding= FragmentFiveBinding.inflate(LayoutInflater.from(context))
       /* context?.let { MyShafePreferens5.init(it) }
        val list = MyShafePreferens5.objectsString
        binding.add.setOnClickListener {
            ...
            dialogView.btn_close.setOnClickListener {
                ...
                MyShafePreferens5.objectsString=list
